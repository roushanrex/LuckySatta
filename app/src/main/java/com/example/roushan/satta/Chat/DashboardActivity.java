...
import com.example.roushan.satta.Chat.adapter.MessageAdapter;
import com.example.roushan.satta.Chat.models.Message;
import com.example.roushan.satta.Chat.models.User;
import com.example.roushan.satta.Chat.utils.AllMethods;
...
//        rvMessage.setLayoutManager(new LinearLayoutManager(DashboardActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==R.id.menuLogout){
            auth.signOut();
            startActivity(new Intent(DashboardActivity.this,Loginchat.class));
            finish();
        }
